<template>
    <div class="mascot-container">
      ...
      >
        <!-- Kafa -->
        <circle cx="100" cy="100" r="70" fill="#3498db" stroke="#2c3e50" stroke-width="4" />
  
        <!-- Gözler -->
        <circle class="eye left" :r="eyeBlink ? 2 : 6" cx="75" cy="90" fill="#fff" />
        <circle class="eye right" :r="eyeBlink ? 2 : 6" cx="125" cy="90" fill="#fff" />
        ...
        <!-- Anten -->
        <line x1="100" y1="30" x2="100" y2="15" stroke="#2c3e50" stroke-width="4"/>
  ...
  <script>
      ...
      methods: {
        startAnimations() {
          ...
          setInterval(() => {
            this.bubbleMessage = this.bubbleMessages[
